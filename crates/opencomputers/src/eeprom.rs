...
///
/// This type combines an EEPROM address, an [`Invoker`] that can be used to make method calls, and
/// a scratch buffer used to perform CBOR encoding and decoding. A value of this type can be
/// created by calling [`Eeprom::lock`], and it can be dropped to return the borrow of the invoker
