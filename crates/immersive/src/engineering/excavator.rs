//! Provides high-level access to the excavator APIs.
...
/// The type name for excavators.
pub const TYPE: &str = "ie_excavator";

/// A excavator component.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub struct Excavator(Address);

impl Excavator {
	/// Creates a wrapper around an excavator.
	///
	/// The `address` parameter is the address of the excavator. It is not checked for correctness
	...
	/// Returns the address of the excavator.
	#[must_use = "This function is only useful for its return value"]
...
impl<'invoker, 'buffer, B: 'buffer + Buffer> Lockable<'invoker, 'buffer, B> for Excavator {
...
/// An excavator component on which methods can be invoked.
///
/// This type combines an excavator address, an [`Invoker`] that can be used to make method calls,
/// and a scratch buffer used to perform CBOR encoding and decoding. A value of this type can be
/// created by calling [`Excavator::lock`], and it can be dropped to return the borrow of the
...
impl<'invoker, 'buffer, B: Buffer> Locked<'invoker, 'buffer, B> {
	/// Returns the amount of energy stored in the excavator’s internal buffer.
	///
	/// # Errors
	...
	/// Returns the maximum amount of energy the excavator’s internal buffer can hold.
	///
	/// # Errors
	/// * [`BadComponent`](Error::BadComponent)
	/// * [`TooManyDescriptors`](Error::TooManyDescriptors)
	...
	/// Returns whether or not the excavator is currently digging.
	///
	/// # Errors
	/// * [`BadComponent`](Error::BadComponent)
	/// * [`TooManyDescriptors`](Error::TooManyDescriptors)
	...
	/// Enables or disables computer control of the excavator.
	///
	/// If `enable` is `true`, the excavator runs or stops based on the most recent call to
	/// [`set_enabled`](#set_enabled). If `enable` is `false`, the excavator runs or stops based on
	...
	/// Enables or disables the excavator.
	///
	/// This can only be called if the excavator is under computer control via a preceding call to
