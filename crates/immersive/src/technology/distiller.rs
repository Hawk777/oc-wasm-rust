...
///
/// This type combines a distiller address, an [`Invoker`](Invoker) that can be used to make method
/// calls, and a scratch buffer used to perform CBOR encoding and decoding. A value of this type
/// can be created by calling [`Distiller::lock`](Distiller::lock), and it can be dropped to return
