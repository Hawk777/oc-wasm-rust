...
///
/// This type combines a heat exchanger address, an [`Invoker`] that can be used to make method
/// calls, and a scratch buffer used to perform CBOR encoding and decoding. A value of this type
/// can be created by calling [`HeatExchanger::lock`], and it can be dropped to return the borrow
