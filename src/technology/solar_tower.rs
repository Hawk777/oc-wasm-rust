...
///
/// This type combines a solar tower address, an [`Invoker`](Invoker) that can be used to make
/// method calls, and a scratch buffer used to perform CBOR encoding and decoding. A value of this
/// type can be created by calling [`SolarTower::lock`](SolarTower::lock), and it can be dropped to
